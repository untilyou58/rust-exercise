...
// Define a struct School with a name and point of students in the school
...
// Implement the function to create a new school
...
// Define an add function for the struct School to add a student to the school
...
// List the current point of the school with the order of increasing and no duplicate
...
// List the students with the same point of the school with the order of alphabet
// Gợi ý: 
...
impl School {
    ...
    pub fn grades(&self) -> Vec<u32> {
        // List the current point of the school with the order of increasing and no duplicate
        let mut grades = self.students.values().cloned().collect::<Vec<u32>>();
        grades.sort();
        grades.dedup();
        grades
    }
    ...
    pub fn grade(&self, grade: u32) -> Vec<String> {
        // List the students in the grade given, sorted by alphabetical order.
        let mut list: Vec<String> = Vec::new();
        for (name, p) in self.students.iter() {
            if *p == grade {
